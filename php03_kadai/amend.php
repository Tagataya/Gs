...
<div class="container">
  ...
  <form  method="post" action="confirm_amend.php">
    <div class="form-group mb-4">
      <label for="bookname">書籍名</label>
      <input type="text" class="form-control" name= "bookname" id="bookname" value="<?=$row["bookname"]?>">
    </div>
    <div class="form-group mb-4">
    ...
    <div class="form-group mb-4">
      ...
      <input type="text" class="form-control" name= "bookurl" id="bookurl" value="<?=$row["bookurl"]?>">
    </div>
    <div class="form-group mb-4">
      <label for="comment">書籍コメント</label>
      <textarea rows="5" class="form-control" name= "comment" id="comment"><?=$row["comment"]?></textarea>
    </div>
    <input type="hidden" name="id" value="<?=$row["id"]?>">
    <hr>
    <button type="submit" class="btn btn-outline-secondary">確認</button>　　
    <input type="button" onclick="history.back()" value="リストへ" class="btn btn-outline-secondary">
  </form>
</div>
</body>
</html>