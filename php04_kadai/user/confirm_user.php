...
<div class="container">
  <h2 class="mt-4 mb-4">登録内容確認</h2>
  <form  method="post" action="write_user.php">
    ...
    <?php
      if($lpw != $lpw2){
        ...
        // $lpw = hash("sha256",$lpw);//従来の表現
        echo '<form method="post" action="write_user.php">';
